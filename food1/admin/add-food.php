...
<div class="main-content">
    <div class="wrapper">
        ...
        <?php 
            ...
            // Kiểm tra nút có được bấm hay không
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        // Image is SElected
                        //A. REnamge the Image
                        //Get the extension of selected image (jpg, png, gif, etc.) "food.jpg" 
                        // Nhận ext phần mở rộng của hình ảnh của chúng tôi (jpg, png, gif, v.v.), ví dụ: "specialfood1.jpg"
